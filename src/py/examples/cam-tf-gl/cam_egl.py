...
class EglState:
    def __init__(self, native_display = egl.EGL_DEFAULT_DISPLAY, native_visual_id=0):
        ...
        if False:
            ...
            if not egl.eglGetConfigs(self.display, configs, num_configs.value, num_configs):
                raise RuntimeError('Failed to get EGL configs')

            for config in configs:
                _print_egl_config(self.display, config)
